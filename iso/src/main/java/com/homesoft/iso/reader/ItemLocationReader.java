...
public class ItemLocationReader extends FullBoxReader implements TypedParser {

    @NonNull
    @Override
    public ItemLocation[] read(Box box, StreamReader streamReader, int versionFlags) throws IOException {
