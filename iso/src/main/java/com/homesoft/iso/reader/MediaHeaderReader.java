...
public class MediaHeaderReader extends FullBoxReader implements TypedParser {
    @Override
    public MediaHeader read(Box box, StreamReader streamReader, int versionFlags) throws IOException {
