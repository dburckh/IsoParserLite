 ...
 * }
*/
public class ESDescriptorReader extends FullBoxReader implements TypedParser {
    ...
    @Nullable
    @Override
    public DecoderConfigDescriptor read(Box box, StreamReader streamReader, int versionFlags) throws IOException {
